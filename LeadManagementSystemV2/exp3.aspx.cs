...
namespace LeadManagementSystemV2
{
    public partial class exp3 : System.Web.UI.Page
    {
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				string path = ConfigurationManager.AppSettings["ChemicalPoliciesPath"].ToString();
		...
		{
			string filename = ConfigurationManager.AppSettings["ChemicalPoliciesPath"].ToString() + TreeView1.SelectedNode.ValuePath.Substring(TreeView1.SelectedNode.ValuePath.IndexOf("/") + 1);
